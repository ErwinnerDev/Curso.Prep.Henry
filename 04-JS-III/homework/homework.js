...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  let muntiplicacion=1;
  for (let index = 0; index < arguments.length; index++) {
    muntiplicacion =muntiplicacion* arguments[index];
    
  }
  return muntiplicacion;
}
...
function todosIguales(arreglo) {
  ...
  for (let index = 0; index < arreglo.length; index++) {
    if(comparar===undefined){
      comparar=arreglo[index];
    }else{
      if(comparar===arreglo[index]){
...
function breakStatement(numero) {
  ...
  for (let index = 0; index <10; index++) {
    if(arrayNuevo.length===0){
      arrayNuevo.push((numero+2));
    }else{
      if(arrayNuevo[arrayNuevo.length-1]+2===index){
        return "Se interrumpió la ejecución";
      }
      arrayNuevo.push((arrayNuevo[arrayNuevo.length-1])+2);
    }
  }
  return arrayNuevo;
}
